...
class Card extends React.Component {
  ...
  get expiry() {
    const expiry = this.props.expirymonth + "/" + this.props.expiryyear;
      ...
      <div key="Cards" className="rccs">
        <div
          className={[
            ...
            (focused === "cvc" && "rccs__card--flipped": "")
          ]
            .join(" ")
            .trim()}
        >
          <div className="rccs__card--front">
            ...
            <div
              className={[
                ...
                .trim()}
            >
              <div className="rccs__nameLabel">Card Holder</div>
              <div className="rccs__namevalue">{name || placeholders.name}</div>
            </div>
            <div
              className={[
                "rccs__expiry",
                focused === "expiry" ? "rccs--focused" : "",
                expiry.substr(0, 1) !== "M" ? "rccs--filled" : ""
              ]
                .join(" ")
                .trim()}
            >
          ...
          <div className="rccs__card--back">
            ...
            <div className={["rccs__cvc"].join(" ").trim()}>{cvc}</div>
            <div className="rccs__issuer" />
          </div>
        </div>
      </div>
